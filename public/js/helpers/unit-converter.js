...
define(function () {
    ...
    var defaultUnitType = 'length',
        ...
        'degree': {
            ...
            to: 1,
            max: 360,
            onOutOfBoundary: function onOutOfBoundary(currentValue) {
        ...
        checkUnitAcceptable = function checkUnitAcceptable(unitName, rates) {
        if (false === rates.hasOwnProperty(unitName)) {
            throw new Error('This unit name is not acceptable');
        }
    },
        initialize = function initialize(unitType) {
    ...
    return {
        ...
        setDefaultUnitType: function setDefaultUnitType(unitType) {
            return initialize(unitType || defaultUnitType);
        },

        from: function from(fromValue, fromUnitName) {
            ...
            return {
                to: function to(toUnitName) {
                    var toValue, toRate, setting;
