 ...
 */
define(['jquery', 'helpers/websocket', 'helpers/point-cloud', 'helpers/data-history'], function ($, Websocket, PointCloudHelper, history) {
    'use strict';
    ...
    return function (opts) {
        ...
        var ws,
            ...
            History = history(),
            splitBinary = function splitBinary(blob, callback) {
        ...
        return {
            connection: ws,
            History: History,
            upload: function upload(name, point_cloud, opts) {
                ...
                var order_name = 'upload',
                    args = [order_name, name, point_cloud.left.size / 24, point_cloud.right.size / 24 || 0];
             ...
             *      ]
             */
            cut: function cut(in_name, out_name, args, opts) {
                opts = opts || {};
                opts.onStarting = opts.onStarting || function () {};
                opts.onFinished = opts.onFinished || function () {};
                ...
                timer = setInterval(function () {
                    if ('undefined' !== typeof next_arg) {
                        _args = [order_name, in_name, out_name, next_arg.mode, next_arg.direction, next_arg.value];
            ...
            deleteNoise: function deleteNoise(in_name, out_name, c, opts) {
                opts = opts || {};
                opts.onFinished = opts.onFinished || function () {};
                opts.onStarting = opts.onStarting || function () {};
                ...
                var self = this,
                    ...
                    args = [order_name, in_name, out_name, c = 'number' === typeof c ? c : 0.3 // default by 0.3
                ];
            ...
            autoMerge: function autoMerge(base, target, output, opts) {
                opts.onStarting = opts.onStarting || function () {};
                opts.onFinished = opts.onFinished || function () {};
                ...
                var self = this,
                    ...
                    args = [order_name, base, target, output];

                events.onMessage = function (data) {

                    switch (data.status) {
                        case 'ok':
                            self.dump(output, opts);
                            break;
                        case 'fail':
                            opts.onFail();
                            break;
            ...
            merge: function merge(base, target, output, opts) {
                opts.onStarting = opts.onStarting || function () {};
                opts.onFinished = opts.onFinished || function () {};
             ...
             *      }
             */
            dump: function dump(name, opts) {
                opts.onFinished = opts.onFinished || function () {};
                opts.onReceiving = opts.onReceiving || function () {};

                var order_name = 'dump',
                    args = [order_name, name],
             ...
             *      }
             */
            export: function _export(name, file_format, opts) {
                opts.onFinished = opts.onFinished || function () {};

                var order_name = 'export',
                    args = [order_name, name, file_format],
                    blobs = [];
             ...
             *
             */
            applyTransform: function applyTransform(baseName, outName, params, onFinished) {
                onFinished = onFinished || function () {};

                var args = ['apply_transform', baseName, params.pX || 0, params.pY || 0, params.pZ || 0, params.rX || 0, params.rY || 0, params.rZ || 0, outName],
             ...
             *
             */
            import: function _import(name, fileType, file, fileLength) {
                var self = this,
                    $deferred = $.Deferred(),
                    args = ['import_file', name, fileType, fileLength],
                    opts = {
                    onFinished: function onFinished(pointCloud) {
             ...
             * @return {Promise}
             */
            export_threading: function export_threading(name, fileType) {
                var self = this,
                    $deferred = $.Deferred(),
                    args = ['export_threading', name, fileType];
             ...
             * @return {Promise}
             */
            export_collect: function export_collect(name) {
                var self = this,
                    $deferred = $.Deferred(),
                    args = ['export_collect', name],
                    length = 0;
