 ...
 */
define(['helpers/websocket', 'helpers/rsa-key'], function (Websocket, rsaKey) {
    'use strict';
    ...
    return function (opts) {
        var events = {
            ...
            onMessage: function onMessage(data) {
                var is_success = true === (data.has_response || false) && true === (data.reachable || false) && true === (data.auth || false);
        ...
        return {
            connection: ws,
            send: function send(uuid, password) {
