...
define(function () {
    ...
    return function (sourceVersion) {
        var currentVersion = sourceVersion.split('.');
        var meetVersion = function meetVersion(targetVersion) {
            ...
            var targetMinorVersion = targetVersion[1].split(/[ab]/);
            var currentMinorVersion = currentVersion[1].split(/[ab]/);
            ...
            var targetMinorScore = parseInt(targetMinorVersion[0]) * 120000 - parseInt(targetMinorVersion[1] || 0);
            var currentMinorScore = parseInt(currentMinorVersion[0]) * 120000 - parseInt(currentMinorVersion[1] || 0);
        ...
        var meetRequirement = function meetRequirement(key) {
            return meetVersion(requirement[key]);
        };
