...
define(['react', 'reactCreateReactClass'], function (React) {
    ...
    return React.createClass({
        ...
        render: function render() {
            var className,
                ...
                if ('link' === opt.type) {
                    content = React.createElement(
                        'a',
                        _extends({ className: className, key: i, href: opt.href }, attrs, { onClick: opt.onClick }),
                        opt.label
                    );
                    ...
                    content = React.createElement('button', _extends({
                        key: i,
                        title: opt.title,
                        className: className,
            ...
            return 0 < this.props.buttons.length ? React.createElement(
                'div',
                { className: className },
                buttons
