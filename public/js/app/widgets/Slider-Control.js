...
define(['react', 'reactPropTypes', 'plugins/classnames/index'], function (React, PropTypes, ClassNames) {
    ...
    return React.createClass({
        ...
        _handleSliderChange: function _handleSliderChange(key, e) {
        ...
        render: function render() {
            var unitClass = "control pull-right unit-" + this.props.unit;
            ...
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement('input', { className: 'slider', type: 'range',
                            min: this.props.min,
                            max: this.props.max,
                    ...
                    React.createElement('input', { id: this.props.id, type: 'text', value: this.state.sliderValue,
