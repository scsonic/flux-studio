...
define(['react', 'reactDOM', 'helpers/unit-converter', 'app/constants/keycode-constants', 'helpers/round', 'plugins/classnames/index'], function (React, ReactDOM, unitConverter, keyCodeConstants, round, ClassNames) {
    'use strict';
    ...
    return React.createClass({
        ...
        getDefaultProps: function getDefaultProps() {
            return {
                ...
                operators: ['+', '-', '*', '/'],
                handleNumberFormat: function handleNumberFormat(value) {
        ...
        _confirmValue: function _confirmValue(addValue) {
        ...
        _onBlur: function _onBlur(e) {
            e.preventDefault();
            var textboxValue = ReactDOM.findDOMNode(this.refs.unitInput).value;
