...
define(['react', 'jsx!widgets/Modal', 'helpers/i18n'], function (React, Modal, i18n) {
    'use strict';
            ...
            _renderSelectMachineStep: function _renderSelectMachineStep() {
                return React.createElement(
                    ...
                    React.createElement(
                        ...
                        lang.initialize.select_machine_type
                    ),
                    React.createElement(
                        'div',
                        ...
                        React.createElement(
                            'button',
                            {
                                ...
                                onClick: function onClick() {
                                    return location.hash = '#initialize/wifi/select-beambox-type';
                                }
                            },
                            React.createElement(
                                'p',
                        ...
                        React.createElement(
                            'button',
                            {
                                className: 'btn btn-action btn-large',
                                onClick: function onClick() {
                                    return location.hash = '#initialize/wifi/connect-machine';
                                }
                            },
                            React.createElement(
                                'p',
