...
define(['jquery', 'react', 'reactClassset', 'reactDOM', 'reactPropTypes', 'app/actions/laser', 'app/actions/alert-actions', 'app/actions/delta/holder-global-interactions', 'app/actions/progress-actions', 'jsx!views/laser/Setup-Panel', 'jsx!views/holder/Setup-Panel', 'jsx!views/laser/Image-Panel', 'jsx!widgets/File-Uploader', 'jsx!widgets/Modal', 'jsx!views/Printer-Selector', 'jsx!widgets/Button-Group', 'helpers/api/config', 'helpers/i18n', 'helpers/dnd-handler'], function ($, React, ReactCx, ReactDOM, PropTypes, laserEvents, AlertActions, HolderGlobalInteraction, ProgressActions, LaserSetupPanel, HolderSetupPanel, ImagePanel, FileUploader, Modal, PrinterSelector, ButtonGroup, ConfigHelper, i18n, DnDHandler) {
    ...
    return function (args) {
        ...
        var view = React.createClass({
            ...
            // UI events
            _handleStartClick: function _handleStartClick() {
                this.setState({
            ...
            _handleShowOutlineClick: function _handleShowOutlineClick() {
                this.setState({
                    openPrinterSelectorWindow: true,
            ...
            _handleCalibrateClick: function _handleCalibrateClick() {
                this.setState({
                    openPrinterSelectorWindow: true,
            ...
            _handleZProbeClick: function _handleZProbeClick() {
                this.setState({
                    openPrinterSelectorWindow: true,
            ...
            _handleExportClick: function _handleExportClick(filemode) {
                this.state.laserEvents.exportTaskCode(this._fetchFormalSettings(), filemode);
            },

            _handleDragAndDrop: function _handleDragAndDrop(e) {
                e.preventDefault();
            ...
            _onLoadCalibrationImage: function _onLoadCalibrationImage(e) {
            ...
            _inactiveSelectImage: function _inactiveSelectImage(e) {
            ...
            // Lifecycle
            _renderStageSection: function _renderStageSection() {
                var self = this,
                    image_panel_class = ReactCx.cx({
                    'panel object-position': true
                }),
                    imagePanel = this.state.selectedImage ? React.createElement(ImagePanel, {
                    lang: lang,
                ...
                return React.createElement(
                    'div',
                    { ref: 'laserStage', className: 'laser-stage' },
                    React.createElement(
                        'section',
                        { ref: 'operationTable', 'data-close-image-panel': 'true', className: 'operation-table', onClick: closeSubPopup },
                        React.createElement('div', { ref: 'laserObject', 'data-close-image-panel': 'true', className: 'laser-object border-circle', onClick: closeSubPopup }),
                        imagePanel
                    ),
                    paramPanel
                );
            ...
            _renderPrinterSelectorWindow: function _renderPrinterSelectorWindow() {
                ...
                var self = this,
                    onGettingPrinter = function onGettingPrinter(selected_printer) {
            ...
            _renderActionButtons: function _renderActionButtons() {
