...
define(['jquery', 'react', 'jsx!widgets/Select', 'jsx!widgets/List', 'jsx!widgets/Modal', 'jsx!views/laser/Advanced-Panel', 'jsx!widgets/Text-Toggle', 'jsx!widgets/Unit-Input', 'jsx!widgets/Button-Group', 'jsx!widgets/Alert', 'jsx!widgets/Dialog-Menu', 'helpers/api/config', 'helpers/i18n', 'helpers/round', 'plugins/classnames/index'], function ($, React, SelectView, List, Modal, AdvancedPanel, TextToggle, UnitInput, ButtonGroup, Alert, DialogMenu, ConfigHelper, i18n, round, ClassNames) {
    'use strict';
    ...
    return React.createClass({
        ...
        _renderStepHeight: function _renderStepHeight() {
            ...
            return {
                label: React.createElement(
                    ...
                    React.createElement(
                        'span',
                        { className: 'caption' },
                        lang.mill.stepHeight
                    ),
                    React.createElement(
                        'span',
                        null,
                        this.state.defaults.stepHeight
                    ),
                    React.createElement(
                        'span',
                        null,
        ...
        render: function render() {
            var items = [this._renderZOffset(), this._renderOvercut(), this._renderSpeed(), this._renderRepeat(), this._renderStepHeight()];
