...
define(['react', 'reactClassset', 'jsx!widgets/Button-Group'], function (React, ReactCx, ButtonGroup) {
    'use strict';
    ...
    return React.createClass({
        ...
        getDefaultProps: function getDefaultProps() {
            return {
                ...
                hasConvert: false,
                disabledScan: false,
                onScanClick: function onScanClick() {}, // scan/multi scan
                onSaveClick: function onSaveClick() {}, // save as stl
                onRollbackClick: function onRollbackClick() {}, // rollback to pcd
                onConvertClick: function onConvertClick() {}, // convert from point cloud to stl
                onScanAgainClick: function onScanAgainClick() {}, // start over
                onMultiScanClick: function onMultiScanClick() {}, // ready to multi scan
                onCancelMultiScanClick: function onCancelMultiScanClick() {} // cancel multi scan
            };
        },

        _getActionButtons: function _getActionButtons(lang) {
            var self = this,
                buttons = [],
                className;
        ...
        render: function render() {
            ...
            return React.createElement(ButtonGroup, { className: defaultClassName, buttons: buttons });
        }
    });
});