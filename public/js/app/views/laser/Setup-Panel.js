...
define(['jquery', 'react', 'reactDOM', 'reactClassset', 'jsx!widgets/List', 'jsx!widgets/Modal', 'jsx!views/laser/Advanced-Panel', 'jsx!widgets/Text-Toggle', 'jsx!widgets/Unit-Input', 'jsx!widgets/Button-Group', 'jsx!widgets/Alert', 'app/actions/alert-actions', 'jsx!widgets/Dialog-Menu', 'helpers/api/config', 'helpers/i18n', 'helpers/round', 'plugins/classnames/index'], function ($, React, ReactDOM, ReactCx, List, Modal, AdvancedPanel, TextToggle, UnitInput, ButtonGroup, Alert, AlertActions, DialogMenu, config, i18n, round, ClassNames) {
    'use strict';
    ...
    return React.createClass({
        ...
        getDefaultProps: function getDefaultProps() {
            return {
                ...
                onShadingChanged: function onShadingChanged() {}
            };
        },
        ...
        // UI Events
        _togglePanel: function _togglePanel(name, open) {
            var self = this,
                panelMap = {
                advanced: [{
        ...
        _openAdvancedPanel: function _openAdvancedPanel(e) {
            this._togglePanel('advanced', true)();
        },

        _onAdvanceDone: function _onAdvanceDone(material) {
        ...
        _onSaveCustomPreset: function _onSaveCustomPreset(material) {
        ...
        _saveLastestSet: function _saveLastestSet(opts) {
            opts = opts || {};
        ...
        _onPickupMaterial: function _onPickupMaterial(e) {
            e.preventDefault();
        ...
        _onShadingChanged: function _onShadingChanged(e) {
        ...
        _refreshObjectHeight: function _refreshObjectHeight(e, value) {
            this._saveLastestSet({ objectHeight: value });
            this.openSubPopup(e);
        },

        _refreshHeightOffset: function _refreshHeightOffset(e, value) {
            this._saveLastestSet({ heightOffset: value });
            this.openSubPopup(e);
        },

        // Lifecycle
        _renderCustomPresets: function _renderCustomPresets() {
            var self = this,
                ...
                selectPresetMaterial = function selectPresetMaterial(e) {
                var elCustomPresets = ReactDOM.findDOMNode(self.refs.customPresets),
                    meta;
                ...
                handleDelPreset = function handleDelPreset(e) {
                var elCustomPresets = ReactDOM.findDOMNode(self.refs.customPresets),
                    customPresets = config().read('laser-custom-presets') || [],
            ...
            customPresets = customPresets.map(function (opt, i) {
                opt.label = React.createElement(
                    'label',
                    null,
                    React.createElement('input', { name: 'custom-preset-item', type: 'radio' }),
                    React.createElement(
                        'p',
                        { className: 'preset-item-name', 'data-meta': JSON.stringify(opt) },
                        opt.label,
                        React.createElement('i', { className: 'fa fa-times', onClick: handleDelPreset })
                    )
                );
            ...
            content = React.createElement(
                'div',
                { className: 'custom-presets-wrapper', ref: 'customPresets' },
                React.createElement(
                    'p',
                    { className: 'caption' },
                    lang.laser.presets
                ...
                React.createElement(
                    ...
                    React.createElement(
                        'span',
                        { className: 'label' },
                        advancedLang.form.laser_speed.text
                    ),
                    ...
                    React.createElement(
                        'span',
                        { className: 'value-text', ref: 'presetSpeedDisplay', 'data-tail': ' ' + advancedLang.form.laser_speed.unit },
            ...
            return true === self.state.openCustomPresets ? React.createElement(Modal, {
        ...
        _onLoadCalibrationImage: function _onLoadCalibrationImage() {
            this.props.onLoadCalibrationImage();
            this._togglePanel('advanced', false)();
        },


        _renderAdvancedPanel: function _renderAdvancedPanel(default_material) {
            var content = React.createElement(AdvancedPanel, {
                lang: lang,
            ...
            return true === this.state.openAdvancedPanel ? React.createElement(Modal, {
                className: { hasShadow: true },
                content: content,
                onClose: this._togglePanel('advanced', false)
            }) : '';
        ...
        _renderHeightOffset: function _renderHeightOffset() {
            return {
                label: React.createElement(
                    ...
                    React.createElement(
                        'span',
                        { className: 'caption' },
                        lang.laser.print_params.height_offset.text
                    ),
                    React.createElement(
                        'span',
                        null,
                        this.state.defaults.heightOffset
                    ),
                    React.createElement(
                        'span',
                        null,
                        lang.laser.print_params.height_offset.unit
                    )
                ),
                content: React.createElement(
                    'div',
        ...
        _renderObjectHeight: function _renderObjectHeight() {
            return {
                label: React.createElement(
                    'div',
        ...
        _renderMaterialSelection: function _renderMaterialSelection() {
            ...
            return {
                label: React.createElement(
                    'div',
                    { className: 'material-name', title: lang.laser.title.material },
                    React.createElement(
                        'span',
                        { className: 'caption' },
                        lang.laser.advanced.form.object_options.text
                    ),
                    React.createElement(
                        'span',
                        null,
        ...
        _renderShading: function _renderShading() {
            ...
            return {
                label: React.createElement(TextToggle, {
                    ref: 'shading',
                    className: classes,
        ...
        _renderAlert: function _renderAlert() {
            var buttons = [{
            ...
            return true === this.state.showAlert ? React.createElement(Modal, {
                className: { hasShadow: true },
                content: content,
        ...
        _renderAdvancedButton: function _renderAdvancedButton() {
            return {
                label: React.createElement(
                    'button',
                    {
