...
define(['react', 'reactDOM', 'reactPropTypes', 'jsx!widgets/Button-Group', 'jsx!widgets/Text-Input', 'jsx!widgets/Unit-Input', 'helpers/api/config', 'plugins/classnames/index', 'helpers/round', 'app/actions/input-lightbox-actions', 'jsx!widgets/File-Uploader', 'helpers/i18n', 'plugins/jquery/serializeObject', 'helpers/array-findindex'], function (React, ReactDOM, PropTypes, ButtonGroup, TextInput, UnitInput, config, classNames, round, InputLightboxActions, FileUploader, i18n) {
    'use strict';
    ...
    return React.createClass({
        ...
        // Private methods
        _getFooterButtons: function _getFooterButtons() {
            var buttonGroup = [{
        ...
        _applySetting: function _applySetting(e) {
            this.props.onDone();
        },

        // UI Events
        _onLoadPreset: function _onLoadPreset(e) {
        ...
        _onSaveAndApply: function _onSaveAndApply(e) {
            var self = this,
                material = {
            ...
            InputLightboxActions.open('save-laser-preset', {
                ...
                maxLength: 20,
                onSubmit: function onSubmit(presetName) {
        ...
        _onCustomBackground: function _onCustomBackground(e) {
            var self = this;
        ...
        _changeInputNumber: function _changeInputNumber() {
            var self = this,
        ...
        _changeRangeNumber: function _changeRangeNumber() {
            var self = this,
        ...
        _updateDefaultMaterial: function _updateDefaultMaterial(defaultMaterial) {
        ...
        _renderFooter: function _renderFooter() {
            ...
            var buttons = this._getFooterButtons(),
                ctrlButtons = this._getControlButtons();

            return React.createElement(
                'div',
                null,
                React.createElement(ButtonGroup, { className: 'footer clearfix', buttons: buttons }),
                React.createElement('hr', { className: 'clearfix' }),
                React.createElement(ButtonGroup, { className: 'footer clearfix', buttons: ctrlButtons })
            );
        },

        _renderSaveForm: function _renderSaveForm() {
            var maxLength = 10;
            return React.createElement(
                'div',
                { className: 'form' },
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(TextInput, { ref: 'presetName', maxLength: maxLength })
                    )
                )
            );
        },

        _renderDefaultForm: function _renderDefaultForm() {
            return React.createElement(
                'form',
                { ref: 'advancedForm', className: 'form' },
                React.createElement(
                    'div',
        ...
        _renderFileUploader: function _renderFileUploader() {
            var style = { display: 'none' };
            return React.createElement('input', { style: style, 'data-ref': 'importBg', type: 'file', accept: '.jpg,.png,.bmp', onChange: this._handleImport });
        },
