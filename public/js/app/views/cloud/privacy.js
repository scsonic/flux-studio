        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    'h2',
                    null,
                    'Welcome to the FLUX Privacy Policy'
                ),
                React.createElement(
                    'p',
                    null,
                ...
                React.createElement(
                    'h3',
                    null,
                    'What personal information do we collect from the people that visit our website, software or app?'
                ),
                React.createElement(
                    'p',
                    null,
                ...
                React.createElement(
                    'p',
                    null,
                    'When you use FLUX Studio, we may collect anonymous usage data to improve the product quality. '
                ),
                React.createElement(
                    'p',
                    null,
                    'When you use FLUX Cloud, we may collect the associations of your email and the serial number of your devices, status and usage data of your FLUX devices, and gain access to the camera on your FLUX devices, however, we will not store any image or video data. '
                ),
                React.createElement(
                    'h3',
                    null,
                ...
                React.createElement(
                    'p',
                    null,
                    'We collect information from you when you register on our site, place an order, subscribe to a newsletter, respond to a survey, open a support ticket, sign in FLUX Cloud, use FLUX Studio or enter information on our site.'
                ),
                React.createElement(
                    'h3',
                    null,
                ...
                React.createElement(
                    'p',
                    null,
                    'However, you will still be able to place orders Shopping cart, Member system by contacting customer service.'
                ),
                React.createElement(
                    'h3',
                    null,
                ...
                React.createElement(
                    'p',
                    null,
                    'Flux Inc. 10F-2, No.125, Section 2., Keelung Rd., Taipei 110, Taiwan',
                    React.createElement(
                        'a',
                        { href: 'mailto:support@flux3dp.com' },
                        'support@flux3dp.com'
                    )
                )
            ),
