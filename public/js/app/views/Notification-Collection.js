...
define(['jquery', 'react', 'lib/jquery.growl', 'helpers/api/config', 'helpers/check-software-update', 'helpers/software-updater',
// alert dialog
'app/actions/alert-actions', 'app/stores/alert-store', 'app/constants/alert-constants',
// progress dialog
'app/actions/progress-actions', 'app/stores/progress-store', 'app/constants/progress-constants',
// input lightbox dialog
'app/actions/input-lightbox-actions', 'app/stores/input-lightbox-store', 'app/constants/input-lightbox-constants', 'jsx!widgets/Progress', 'jsx!widgets/Input-Lightbox', 'jsx!widgets/Notification-Modal', 'jsx!views/Update-Dialog', 'jsx!views/Change-Filament', 'jsx!views/Head-Temperature', 'jsx!views/beambox/Camera-Calibration', 'app/actions/global-actions', 'app/stores/global-store', 'jsx!views/print/Monitor', 'jsx!widgets/Modal', 'helpers/api/discover', 'helpers/check-firmware', 'helpers/firmware-updater', 'helpers/device-list', 'helpers/device-master'], function ($, React, Notifier, config, checkSoftwareUpdate, softwareUpdater,
// alert
AlertActions, AlertStore, AlertConstants,
// progress
ProgressActions, ProgressStore, ProgressConstants,
// input lightbox
        ...
        return React.createClass({
            ...
            componentDidMount: function componentDidMount() {
                var self = this,
                    ...
                    type = 'firmware',
                    _checkFirmwareOfDefaultPrinter = function _checkFirmwareOfDefaultPrinter() {
                    var printers = DeviceMaster.getAvailableDevices();
            ...
            componentWillUnmount: function componentWillUnmount() {
                ...
                // progress
                ProgressStore.removeOpenedListener(this._handleProgress).removeUpdatingListener(this._handleProgress).removeClosedListener(this._handleProgressFinish);
            ...
            _monitorUsb: function _monitorUsb(usbOn) {
            ...
            _showChangeFilament: function _showChangeFilament(payload) {
            ...
            _showCameraCalibration: function _showCameraCalibration(payload) {
                this.setState({
                    cameraCalibration: {
                        open: true,
                        device: payload.device
            ...
            _hideChangeFilament: function _hideChangeFilament() {
                this.setState({
                    changeFilament: {
                        open: false
                    }
            ...
            _closeHeadTemperature: function _closeHeadTemperature() {
                this.setState({
                    headTemperature: {
                        show: false
                    }
            ...
            _showUpdate: function _showUpdate(payload) {
            ...
            _showHeadTemperature: function _showHeadTemperature(payload) {
            ...
            _handleUpdateClose: function _handleUpdateClose() {
                this.setState({
                    application: {
                        open: false,
            ...
            _handleUpdateDownload: function _handleUpdateDownload() {
                this.state.application.onDownload();
            },

            _handleUpdateInstall: function _handleUpdateInstall() {
                this.state.application.onInstall();
            },

            _handleInputLightBoxOpen: function _handleInputLightBoxOpen(payload) {
                this.setState({
                    inputLightbox: {
                        open: true,
                        type: payload.type,
            ...
            _handleInputLightBoxClosed: function _handleInputLightBoxClosed(e, reactid, from) {
                this.setState({
                    inputLightbox: {
                        open: false
                    }
            ...
            _handleInputLightBoxSubmit: function _handleInputLightBoxSubmit(value) {
                return this.state.inputLightbox.onSubmit(value);
            },

            _handleProgress: function _handleProgress(payload) {
                var self = this,
                    hasStop;
            ...
            _handleProgressFinish: function _handleProgressFinish() {
                var self = this;
            ...
            _handleProgressStop: function _handleProgressStop(payload) {
            ...
            _handleNotification: function _handleNotification(type, message, onClickCallback, fixed) {
                var growl;
                fixed = fixed || false;
            ...
            _handleCloseNotification: function _handleCloseNotification() {
                $('#growls').remove();
            },

            _handlePopup: function _handlePopup(type, id, caption, message, customText, args) {
            ...
            _handleClosePopup: function _handleClosePopup() {
                this.setState({ showNotificationModal: false });
            },

            _handleNotificationModalClose: function _handleNotificationModalClose(e, reactid, from) {
                var from = from || '';
            ...
            _handlePopupFeedBack: function _handlePopupFeedBack(type) {
            ...
            _handleOpenMonitor: function _handleOpenMonitor(payload) {
                this.setState({
                    fcode: payload.fcode,
                    showMonitor: true,
            ...
            _handlecloseMonitor: function _handlecloseMonitor() {
                this.setState({
                    showMonitor: false
                });
            },
            ...
            _handleSetHeadTemperature: function _handleSetHeadTemperature(e) {
                DeviceMaster.setHeadTemperature(this.state.headTemperature.target);
            },

            _renderMonitorPanel: function _renderMonitorPanel() {
                var content = React.createElement(Monitor, {
                    lang: lang,
            ...
            _renderChangeFilament: function _renderChangeFilament() {
                return React.createElement(ChangeFilament, {
            ...
            _renderHeadTemperature: function _renderHeadTemperature() {
                return React.createElement(HeadTemperature, {
                    device: this.state.headTemperature.device,
                    onClose: this._closeHeadTemperature
                });
            },

            _renderCameraCalibration: function _renderCameraCalibration() {
                var _this = this;

                return React.createElement(CameraCalibration, {
            ...
            render: function render() {
                ...
                return React.createElement(
                    ...
                    React.createElement(InputLightbox, {
